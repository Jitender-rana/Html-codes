...
app.post("/submit", (req, res) => {
  ...
  const randomnum1=Math.floor(adj.length*(Math.random()));
  const randomnum2=Math.floor(noun.length*(Math.random()));
  let fn=adj[randomnum1];
  let ln=noun[randomnum2];
  let bn=fn+" "+ln;
  res.render("index.ejs",{bandname: bn});
